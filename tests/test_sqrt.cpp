...
TEST(SquareRootTest, Sqrt7With_1_000_000_DigitsAtK19) {
  ...
  constexpr std::size_t precision_digits = 1'000'002;
  constexpr std::size_t truncate_to = 1'000'000;
  const std::string data_path = "../data/sqrt_7.txt";
...
TEST(SquareRootTest, sqrt_5_with_1_000_000_digits_at_k_19) {
  constexpr unsigned long target = 5UL;
  constexpr unsigned long k = 20UL;
  constexpr std::size_t precision_digits = 1'000'002;
  constexpr std::size_t truncate_to = 1'000'000;
  const std::string data_path = "../data/sqrt_5.txt";
...
TEST(SquareRootTest, sqrt_2_with_10_000_000_digits_at_k_30) {
  constexpr unsigned long target = 2UL;
  ...
  const std::string data_path = "../data/data_sqrt2_10mil.txt";
